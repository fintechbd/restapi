...
class IndexKycStatusRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'usre_id' => ['integer', 'nullable', 'min:1'],
            'type' => ['string', 'nullable', 'min:1'],
            'status' => ['string', 'nullable', 'min:1'],
            'vendor' => ['string', 'nullable', 'min:1'],
        ];
    }
