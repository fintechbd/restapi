...
class ImportBeneficiaryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'beneficiary_data.*.instant_bank_branch_id' => ['nullable', 'string'],
            'beneficiary_data.*.instant_bank_account_number' => ['nullable', 'string'],
            'beneficiary_data.*.bank_id' => ['nullable', 'string'],
            'beneficiary_data.*.bank_branch_id' => ['nullable', 'string'],
            ...
            'beneficiary_data.*.wallet_id' => ['nullable', 'string'],
