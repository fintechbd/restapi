    ...
    public function toArray($request)
    {
        return $this->collection->map(function ($deposit) {
            $data = [
                ...
                'amount_formatted' => (string) currency($deposit->amount ?? null, $deposit->currency),
                'slip' => $deposit->getFirstMediaUrl('slip') ?? null,
                'currency' => $deposit->currency ?? null,
                'converted_amount' => $deposit->converted_amount ?? null,
                'converted_amount_formatted' => (string) currency($deposit->converted_amount ?? null, $deposit->converted_currency),
