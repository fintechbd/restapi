    ...
    public function toArray($request)
    {
        return $this->collection->map(function ($bdtopup) {
            $data = [
                ...
                'amount_formatted' => (string) currency($bdtopup->amount ?? null, $bdtopup->currency),
                'currency' => $bdtopup->currency ?? null,
                'converted_amount' => $bdtopup->converted_amount ?? null,
                'converted_amount_formatted' => (string) currency($bdtopup->converted_amount ?? null, $bdtopup->converted_currency),
