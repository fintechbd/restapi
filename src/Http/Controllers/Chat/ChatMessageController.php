...
class ChatMessageController extends Controller
{
    ...
    public function update(UpdateChatMessageRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return $this->updated(__('restapi::messages.resource.updated', ['model' => 'Chat Message']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return $this->deleted(__('restapi::messages.resource.deleted', ['model' => 'Chat Message']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return $this->restored(__('restapi::messages.resource.restored', ['model' => 'Chat Message']));
    ...
    public function export(IndexChatMessageRequest $request): JsonResponse
    {
        try {
            ...
            return $this->exported(__('restapi::messages.resource.exported', ['model' => 'Chat Message']));
