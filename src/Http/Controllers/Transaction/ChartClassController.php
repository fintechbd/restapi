...
class ChartClassController extends Controller
{
    ...
    public function update(UpdateChartClassRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return $this->updated(__('restapi::messages.resource.updated', ['model' => 'Chart Class']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return $this->deleted(__('restapi::messages.resource.deleted', ['model' => 'Chart Class']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return $this->restored(__('restapi::messages.resource.restored', ['model' => 'Chart Class']));
    ...
    public function export(IndexChartClassRequest $request): JsonResponse
    {
        try {
            ...
            return $this->exported(__('restapi::messages.resource.exported', ['model' => 'Chart Class']));
     ...
     * @lrd:end
     *
     * @return \Fintech\RestApi\Http\Resources\Transaction\ChartClassCollection|JsonResponse
     */
