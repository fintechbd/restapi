...
use Fintech\RestApi\Http\Requests\Bell\ImportTriggerActionRequest;
use Fintech\RestApi\Http\Requests\Bell\IndexTriggerActionRequest;
use Fintech\RestApi\Http\Requests\Bell\StoreTriggerActionRequest;
use Fintech\RestApi\Http\Requests\Bell\UpdateTriggerActionRequest;
use Fintech\RestApi\Http\Resources\Bell\TriggerActionCollection;
use Fintech\RestApi\Http\Resources\Bell\TriggerActionResource;
...
class TriggerActionController extends Controller
{
    ...
    public function store(StoreTriggerActionRequest $request): JsonResponse
    {
        try {
            ...
            return response()->created([
                'message' => __('restapi::messages.resource.created', ['model' => 'Trigger Action']),
                'id' => $triggerAction->id,
            ]);
    ...
    public function update(UpdateTriggerActionRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return response()->updated(__('restapi::messages.resource.updated', ['model' => 'Trigger Action']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return response()->deleted(__('restapi::messages.resource.deleted', ['model' => 'Trigger Action']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return response()->restored(__('restapi::messages.resource.restored', ['model' => 'Trigger Action']));
    ...
    public function export(IndexTriggerActionRequest $request): JsonResponse
    {
        try {
            ...
            return response()->exported(__('restapi::messages.resource.exported', ['model' => 'Trigger Action']));
