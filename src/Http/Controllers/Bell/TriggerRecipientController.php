...
use Fintech\RestApi\Http\Requests\Bell\ImportTriggerRecipientRequest;
use Fintech\RestApi\Http\Requests\Bell\IndexTriggerRecipientRequest;
use Fintech\RestApi\Http\Requests\Bell\StoreTriggerRecipientRequest;
use Fintech\RestApi\Http\Requests\Bell\UpdateTriggerRecipientRequest;
use Fintech\RestApi\Http\Resources\Bell\TriggerRecipientCollection;
use Fintech\RestApi\Http\Resources\Bell\TriggerRecipientResource;
...
class TriggerRecipientController extends Controller
{
    ...
    public function store(StoreTriggerRecipientRequest $request): JsonResponse
    {
        try {
            ...
            return response()->created([
                'message' => __('restapi::messages.resource.created', ['model' => 'Trigger Recipient']),
    ...
    public function update(UpdateTriggerRecipientRequest $request, string|int $id): JsonResponse
    {
        try {
            ...
            return response()->updated(__('restapi::messages.resource.updated', ['model' => 'Trigger Recipient']));
    ...
    public function destroy(string|int $id)
    {
        try {
            ...
            return response()->deleted(__('restapi::messages.resource.deleted', ['model' => 'Trigger Recipient']));
    ...
    public function restore(string|int $id)
    {
        try {
            ...
            return response()->restored(__('restapi::messages.resource.restored', ['model' => 'Trigger Recipient']));
    ...
    public function export(IndexTriggerRecipientRequest $request): JsonResponse
    {
        try {
            ...
            return response()->exported(__('restapi::messages.resource.exported', ['model' => 'Trigger Recipient']));
