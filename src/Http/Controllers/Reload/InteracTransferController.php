...
/**
 * Class InteracTransferController
 *
 * @lrd:start
...
class InteracTransferController extends Controller
{
    ...
    /**
     * @lrd:start
     * Return a listing of the *Interac-E-Transfer* resource as collection.
     *
    ...
    public function index(IndexDepositRequest $request): DepositCollection|JsonResponse
    {
        try {
            ...
            $inputs['transaction_form_code'] = 'e_reload_transfer';
    ...
    /**
     * @lrd:start
     * Create a new *Interac-E-Transfer* resource in storage.
     *
     * @lrd:end
     *
     * @throws StoreOperationException
     */
    public function store(StoreInteracTransferRequest $request): JsonResponse
    {
        try {
            $inputs = $request->validated();
    ...
    /**
     * @lrd:start
     * Return a specified *Interac-E-Transfer* resource found by id.
     *
     * @lrd:end
     *
    ...
    /**
     * @lrd:start
     * Reject a  specified *Interac-E-Transfer* resource found by id.
    ...
    /**
     * @lrd:start
     * Accept a  specified *Interac-E-Transfer* resource found by id.
     * if and only if deposit status is processing
     *
     * @lrd:end
     *
    ...
    /**
     * @lrd:start
     * Cancel a  specified *Interac-E-Transfer* resource found by id.
    ...
    /**
     * @lrd:start
     * Create a exportable list of the *Interac-E-Transfer* resource as document.
    ...
    /**
     * @lrd:start
     * Create an exportable list of the *Interac-E-Transfer* resource as document.
     * After export job is done system will fire  export completed event
     *
     * @lrd:end
     */
