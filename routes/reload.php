...
if (Config::get('fintech.reload.enabled')) {
    Route::prefix('reload')->name('reload.')
        ...
        ->group(function () {
            ...
            Route::apiResource('wallet-to-banks', \Fintech\RestApi\Http\Controllers\Reload\WalletToBankController::class);
            Route::post('wallet-to-banks/{wallet_to_bank}/restore', [\Fintech\RestApi\Http\Controllers\Reload\WalletToBankController::class, 'restore'])->name('wallet-to-banks.restore');

            Route::apiResource('wallet-to-atms', \Fintech\RestApi\Http\Controllers\Reload\WalletToAtmController::class);
            Route::post('wallet-to-atms/{wallet_to_atm}/restore', [\Fintech\RestApi\Http\Controllers\Reload\WalletToAtmController::class, 'restore'])->name('wallet-to-atms.restore');

            Route::apiResource('wallet-to-prepaid-cards', \Fintech\RestApi\Http\Controllers\Reload\WalletToPrepaidCardController::class);
            Route::post('wallet-to-prepaid-cards/{wallet_to_prepaid_card}/restore', [\Fintech\RestApi\Http\Controllers\Reload\WalletToPrepaidCardController::class, 'restore'])->name('wallet-to-prepaid-cards.restore');
